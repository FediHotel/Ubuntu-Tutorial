...
No run : ```vi /etc/nginx/sites-available/cms.conf``` Paste the following in the cms.conf file, And change the ###URL### to your domain
...
```n -s /etc/nginx/sites-available/cms.conf /etc/nginx/sites-enabled/```
